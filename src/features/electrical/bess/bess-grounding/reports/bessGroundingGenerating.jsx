...
export default function BessGroundingGenerating({ values, onDone }) {
  const steps = ['Validating inputs', 'Resolving template & constants', 'Modeling grid potentials', 'Calculating step and touch voltages', 'Composing document', 'Finalizing PDF'];
  ...
  return (
    <div style={{ flex: 1, display: 'grid', placeItems: 'center', background: 'var(--bg)' }}>
      <div style={{ width: 340, textAlign: 'center' }} className="fade-up">
        ...
        <div className="mono" style={{ fontSize: 12, color: 'var(--text-3)', marginBottom: 24 }}>{bessGroundingDocNumber(values)}.docx</div>
